...
public class ReferralSourcePageService {
	...
	public Referral_Source loadReferralSourceForm(DynamicForm dynamicForm,
		...
		// input
		try {
			JSONObject jsonDataOfIp = new JSONObject(ip);
			// to get ip

			referral_Source.setLongitude(jsonDataOfIp.getString("lon"));
			referral_Source.setLatitude(jsonDataOfIp.getString("lat"));
			referral_Source.setIp(jsonDataOfIp.getString("query"));

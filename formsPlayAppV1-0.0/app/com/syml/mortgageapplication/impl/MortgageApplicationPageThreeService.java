...
public class MortgageApplicationPageThreeService {
	...
	public Opportunity loadFormData(Opportunity opportunity,DynamicForm dynamicForm){
		...
		if (garagetype != null && !garagetype.equalsIgnoreCase("None")) {
	...
	private String getPropertyHeated(String propertyheated){
		if (propertyheated != null && propertyheated.equalsIgnoreCase("Furnace")) {
			return "1";
		} else if (propertyheated != null && propertyheated.equalsIgnoreCase("Electric")) {
			return "2";
		}else if (propertyheated != null && propertyheated.equalsIgnoreCase("Hot Water") || propertyheated.equalsIgnoreCase("In Floor")) {
			return "3";
		}else
		return "4";
	}
	...
	public String getWater(String getWater) {
		if (getWater != null && getWater.equalsIgnoreCase("Municipal")) {
			return "1";
				...
				&& getWater.equalsIgnoreCase("Private Well")

...
public class MortgageApplicationPage2RefService {
	...
	public LendingTerm getRefinanceDetails(Opportunity opportunity) throws MortgageApplicationPageServiceException{
		...
		lendingTerm.setMarketValue(opportunity.getProperty_value()+"");
		lendingTerm.setRentalAmount(opportunity.getMonthly_rental_income()+"");
		lendingTerm.setAdditionalAmount(opportunity.getAdditional_amount()+"");

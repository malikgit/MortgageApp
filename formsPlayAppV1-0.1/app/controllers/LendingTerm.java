...
public class LendingTerm {
	...
	public String getRrspAmount() {
		return rrspAmount;
	}

	public void setRrspAmount(String rrspAmount) {
	...
	public String getSaleOfPropertyAmount() {
		return saleOfPropertyAmount;
	}

	public void setSaleOfPropertyAmount(String saleOfPropertyAmount) {
		this.saleOfPropertyAmount = saleOfPropertyAmount;
	}
	...
	public String getExistingEquityAmount() {
		return existingEquityAmount;
	}

	public void setExistingEquityAmount(String existingEquityAmount) {
		this.existingEquityAmount = existingEquityAmount;
	}

	public String getSweatEnquityAmount() {
		return sweatEnquityAmount;
	}

	public void setSweatEnquityAmount(String sweatEnquityAmount) {
		this.sweatEnquityAmount = sweatEnquityAmount;
	}

	private String rrspAmount;
	private String investmentAmount;
	private String borrowedAmount;
	private String saleOfPropertyAmount;
	private String giftAmount;
	private String personalAmount;
	private String existingEquityAmount;
	private String sweatEnquityAmount;
	...
	public LendingTerm(String province, String purchasePrice, String downpayment, String address, boolean bankAccount,
			boolean rrsps, boolean investments, boolean borrowed, boolean saleOfProperty, boolean gift,
			boolean personalCash, boolean existingEquity, boolean sweetEquity, String whoWillLiving,
			String rentalAmount, boolean buyProperty, boolean payOffDebt, boolean buyInvestments, boolean buyVehicle,
			boolean renovate, boolean refurnish, boolean vacation, boolean recVehicle, boolean other,
			String marketValue, String additionalAmount, String bankAmount, String rrspAmount, String investmentAmount,
			String borrowedAmount, String saleOfPropertyAmount, String giftAmount, String personalAmount,
			String existingEquityAmount, String sweatEnquityAmount, String mlsListed) {
		super();
